...
// ─────────────────────────────────────────────────────────────────────
//   MCU TX  -> 트랜시버 D  (또는 TXD)   [메인 보드 실배선: GPIO1]
//   MCU RX  -> 트랜시버 R  (또는 RXD)   [메인 보드 실배선: GPIO2]
...
// 실물 배선 확인 완료 (2026-08-03 통신 테스트에서 검증).
// GPIO1 -> CAN 트랜시버 보드의 TX(D) 입력, GPIO2 <- 트랜시버 보드의 RX(R) 출력.
#define PIN_CAN_TX 1   // 트랜시버 D 핀에 연결됨 (확인 완료)
#define PIN_CAN_RX 2   // 트랜시버 R 핀에 연결됨 (확인 완료)
