  /**
MKS ESP32 FOC 홀 센서 폐루프 위치 제어 예제 | 테스트 라이브러리: SimpleFOC 2.2.1 | 테스트 하드웨어: MKS ESP32 FOC V1.0
...
프로그램 기본 공급 전압은 16.8V입니다. 다른 전압 사용 시 voltage_power_supply, voltage_limit 변수 값을 수정하세요.
